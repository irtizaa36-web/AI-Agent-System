...
function printUsage(stdout: (line: string) => void): void {
  stdout(
    [
      ...
      "  orchestrator jobs run --profile <name>|--all                Run the job-search pipeline and write today's digest",
      "  orchestrator jobs <subcommand> --profile <name>             reconcile, check-feedback, enrich-contact, digest, sources, dashboard",
      "  orchestrator jobs costs|profiles                            Review model spend, or list configured profiles",
      ...
      "jobs subcommands: run `orchestrator jobs help` for the full list.",
      "",
